...
$now = (date('Y-m-d'));
// echo $days;
$sql = mysqli_query($conn, "UPDATE tbltransaksi SET idadmin = '$idadmin', tgl_kembali = '$now', status =  'kembali', denda = '$days' ,jumlah_denda = '$jumlahDenda' WHERE  idtransaksi = $idtransaksi");
